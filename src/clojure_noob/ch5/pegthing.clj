(ns clojure-noob.ch5.pegthing
  (:require [clojure.set :as set]))

(declare successful-move prompt-move game-over query-rows)

(defn tri*
  "Generates lazy sequence of triangle numbers"
  ([] (tri* 0 1))
  ([sum n]
   (let [new-sum (+ sum n)]
...
(defn row-padding
  "String of spaces to add to teh beginning of a row to center it"
  [row-num rows]
...
(defn prompt-move
  ...
  (println "\nHere's your board:")
  (print-board board)
  (println "Move from where to where? Enter two letetrs:")
